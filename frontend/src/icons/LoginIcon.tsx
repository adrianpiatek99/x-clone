...
const SvgLoginIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg viewBox='0 0 900 1000' fill='currentColor' height='1em' width='1em' ref={ref} {...props}>
...
const ForwardRef = forwardRef(SvgLoginIcon);
