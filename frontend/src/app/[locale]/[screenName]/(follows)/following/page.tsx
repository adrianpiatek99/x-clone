...
import { useGetUserFollowingQuery } from '@/hooks/api/users/queries';
...
export default function Page() {
  ...
  return (
    <FlatList
      ...
      empty={{
        title: t('profilePage.subpages.following.empty.title'),
        description: t('profilePage.subpages.following.empty.description'),
      }}
    />
  );
}
